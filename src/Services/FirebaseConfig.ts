...
export { auth, signOut, getAnalytics, addDoc,getDoc, setDoc, deleteDoc, updateDoc, onAuthStateChanged, getFirestore, getDocs, collection, initializeApp, query, where, doc, app};
